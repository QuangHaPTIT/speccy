...
public class TestCase extends AuditableAggregateRoot<TestCase> {
    ...
    private TestCaseStatus status = TestCaseStatus.ACCEPTED;
    ...
    private TestCaseMatchMode matchMode = TestCaseMatchMode.EXACT;
    ...
    public TestCase(Long apiModuleId, Long phaseId, String name, String method, String endpoint) {
